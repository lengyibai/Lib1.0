<template>
  <div class="Home">
    <h2>热门组件推荐</h2>
    <a href="/lib-components/Components/statics/TriggerRay"><h3>放射点击效果<span v-html="icon"></span></h3></a>
    ...
    <a href="/lib-components/Functions/element/ScrollParallax"><h3>滚动视差动画<span v-html="icon"></span></h3></a>
